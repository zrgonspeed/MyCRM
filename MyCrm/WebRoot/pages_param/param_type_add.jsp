			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<!-- BEGIN 网页的标题和面包屑-->
						<h3 class="page-title">
							系统参数 <small>参数添加页</small>
						</h3>
						<ul class="breadcrumb">
							<li><i class="icon-home"></i> <a href="#">系统参数管理</a>
								<i class="icon-angle-right"></i> <a href="#">系统参数添加</a>
						</ul>
						<!-- END 网页的标题和面包屑-->
					</div>
				</div>
					...
					<div class="span12">
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form action="param_sys!add" method="post" class="form-horizontal">
									...
									<div class="row-fluid">
										<div class="span12 ">
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" placeholder="必填" name="sysparam.paramsName" class="span12 m-wrap" >
												</div>
											</div>
										</div>
										<!--/span-->
									...
									<div class="row-fluid">
										...
										<div class="span6 ">
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" placeholder="必填" name="sysparam.paramsOrder" class="span12 m-wrap" >
												</div>
											</div>
										</div>
										<!--/span-->
		...
		jQuery(document).ready(function() {
			...
			$.getJSON(url,function(d){
				...
				for ( var int = 0; int < d.length; int++) {
					...
					$("#select2_sample_paramtype").html(chtml);
				}
			});
		});
	</script>
