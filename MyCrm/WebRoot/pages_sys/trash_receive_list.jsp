...
<head>
	<meta charset="utf-8" />
	<title>trash_receive_list.jsp</title>
								...
								<tr>
									...
									<div class="btn-group" style="margin-bottom: 0px !important;">
										...
										<ul class="dropdown-menu">
											<li><a href="crm_receive!trashAdd?receiveid=<s:property value="#listdata.id"/>">
											<i class="icon-edit"></i>数据恢复</a></li>
											<li><a href="crm_receive!trashDel?receiveid=<s:property value="#listdata.id"/>">
