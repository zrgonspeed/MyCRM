					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-edit"></i>岗位回收列表</div>
								<div class="actions">
								</div>
							</div>
												...
												<div class="btn-group" style="margin-bottom: 0px !important;">
													...
													<ul class="dropdown-menu">
														...
														<li><a data-toggle="modal"
															href="hr_post!trashAdd?id=<s:property value="#p.postId" />">
															<i class="icon-edit"></i>数据恢复</a></li>
														<li><a href="hr_post!trashDel?id=<s:property value="#p.postId" />">
