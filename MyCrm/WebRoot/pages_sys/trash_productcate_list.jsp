...
<head>
<meta charset="utf-8" />
<title>trash_productcate_list.jsp</title>
								...
								<table
									...
									<tbody>									
										...
										<tr class="">
											...
											<td>
												<a class="btn mini blue" href="crm_cate!trashAdd?id=<s:property value="#p.id" />"><i class="icon-edit"></i>数据恢复</a>
												<a class="btn mini green" href="crm_cate!trashDel?id=<s:property value="#p.id" />"><i class="icon-trash"></i>彻底删除</a>
											</td>
										</tr>
										</s:iterator>
									</tbody>
