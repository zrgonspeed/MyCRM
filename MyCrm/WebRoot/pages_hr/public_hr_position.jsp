...
<head>
	<meta charset="utf-8" />
	<title>public_hr_position_add.jsp</title>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-edit"></i>职务管理</div>
								<div class="actions">
											...
											<div class="btn-group" style="margin-bottom: 0px !important;">
												...
												<ul class="dropdown-menu">
													...
													<li><a data-toggle="modal"
														href="hr_posi!findOne?id=<s:property value="#p.id" />"><i
															class="icon-edit"></i>编辑</a></li>
													<li><a href="hr_posi!deleteById?id=<s:property value="#p.id" />"><i
