					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="icon-reorder"></i>修改部门
								</div>
							</div>
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form action="hr_dep!update" method="post" class="form-horizontal">
									...
									<div class="row-fluid">
										<div class="span6 ">
											<div class="control-group">
												...
												<div class="controls">
														<textarea name="department.DDescription"  class="m-wrap span10"><s:property value="#listdata.DDescription" /></textarea>
												</div>
											</div>
										</div>
									</div>
