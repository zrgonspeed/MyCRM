...
<head>
	<meta charset="utf-8" />
	<title>public_hr_employee.jsp</title>
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
								<a href="index.html">CRM员工管理</a> 
								<i class="icon-angle-right"></i>
								<a href="index.html">员工管理列表</a> 
								<i class="icon-angle-right"></i>
								岗位列表
							</li>
						</ul>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-edit"></i>员工管理</div>
								<div class="actions">
									<button id="sample_editable_1_new" onclick="location.href='public_hr_employee_add.jsp'" class="btn red">
												...
												<div class="btn-group" style="margin-bottom: 0px !important;">
													...
													<ul class="dropdown-menu">
														...
														<li><a data-toggle="modal"
															href="hr_emp!findOne?id=<s:property value="#p.id" />">
															<i class="icon-edit"></i>编辑</a></li>
														<li><a href="hr_emp!deleteById?id=<s:property value="#p.id" />">
