					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form action="hr_posi!add" method="post" class="form-horizontal">
											...
											<div class="control-group">
												...
												<div class="controls">
													<input name="position.positionOrder" type="text"
														class="m-wrap span10" placeholder="可填">
												</div>
											</div>
										</div>
										<!--/span-->
												...
												<div class="controls">
													<div class="input-append date date-picker"
														...
														<input name="position.createDate"  class="m-wrap m-ctrl-medium date-picker" size="16"
															type="text" placeholder="请选择" value="<s:date name="#listdata.createDate" format="yyyy-MM-dd" />" /> <span class="add-on"><i
