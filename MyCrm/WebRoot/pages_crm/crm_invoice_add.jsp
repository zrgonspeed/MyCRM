...
<head>
	<meta charset="utf-8" />
	<title>crm_invoice_add.jsp</title>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form action="crm_invoice!add" method="post" class="form-horizontal">
									<h3 class="form-section">订单信息</h3>
									<input name="invoice.crmOrder.id" value='<s:property value="#orderid"/>' type="hidden">
									<div class="row-fluid">
										<div class="span6">
											<div class="control-group">
												<label class="control-label">客户：</label>
												<div class="controls">
												<input name="invoice.crmCustomer.id" value='<s:property value="#order.crmCustomer.id"/>' type="hidden">
									...
									<div class="row-fluid">
										<div class="span6 ">
											<div class="control-group">
												...
												<div class="controls">
													<input name="invoice.invoiceAmount" type="text" class="m-wrap span8" >
												</div>
											</div>
										</div>
										<!--/span-->
									...
									<div class="row-fluid">
											...
											<div class="control-group">
												...
												<div class="controls">
													<div class="input-append date date-picker" data-date-format="yyyy-mm-dd" data-date-viewmode="years">
														<input name="invoice.invoiceDate" class="m-wrap m-ctrl-medium date-picker" size="16" type="text" />
										...
										<div class="span6 ">
											<div class="control-group">
												...
												<div class="controls">
													<input name="invoice.invoiceNum" type="text" class="m-wrap span8" >
												</div>
											</div>
										</div>
									</div>
									<div class="row-fluid">
										<div class="span12 ">
											<div class="control-group">
												...
												<div class="controls">
													<textarea name="invoice.invoiceContent" class="m-wrap span8" ></textarea>
												</div>
											</div>
										</div>
									</div>
