...
<head>
	<meta charset="utf-8" />
	<title>crm_receive_update.jsp</title>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="icon-reorder"></i>修改收款信息
								</div>
							</div>
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form action="crm_receive!update" method="post" class="form-horizontal">
									<h3 class="form-section">订单信息</h3>
									<input name="receive.id" value='<s:property value="#receiveid"/>' type="hidden">
									<div class="row-fluid">
										<div class="span6">
									...
									<div class="row-fluid">
										<div class="span6 ">
											<div class="control-group">
												...
												<div class="controls">
													<input name="receive.receiveAmount" value='<s:property value="#receive.receiveAmount"/>' type="text" class="m-wrap span8" >
												</div>
											</div>
										</div>
										<!--/span-->
											...
											<div class="control-group">
												...
												<div class="controls">
													<select name="receive.paramSysparamByReceiveDirectionId.id" id="receive" class="m-wrap span8">
														<option value='<s:property value="#receive.paramSysparamByReceiveDirectionId.id"/>' >原值:<s:property value="#receive.paramSysparamByReceiveDirectionId.paramsName"/></option>
													</select>
												</div>
											</div>
										</div>
									...
									<div class="row-fluid">
											...
											<div class="control-group">
												...
												<div class="controls">
													<select name="receive.paramSysparamByReceiveTypeId.id" id="paytype" class="m-wrap span8">
														<option value='<s:property value="#receive.paramSysparamByReceiveTypeId.id"/>' >原值:<s:property value="#receive.paramSysparamByReceiveTypeId.paramsName"/></option>
													</select>
												</div>
											</div>
										</div>
										<div class="span6 ">
											<div class="control-group">
												...
												<div class="controls">
													<input name="receive.receiveNum" value="<s:property value="#receive.receiveNum"/>" type="text" class="m-wrap span8" >
												</div>
											</div>
										</div>
									</div>
											...
											<div class="control-group">
												...
												<div class="controls">
													<div class="input-append date date-picker" data-date-format="yyyy-mm-dd" data-date-viewmode="years">
														<input name="receive.receiveDate" value="<s:date name="#receive.receiveDate" format="yyyy-MM-dd"/>" class="m-wrap m-ctrl-medium date-picker" size="16" type="text" />
											...
											<div class="control-group">
												...
												<div class="controls">
													<select name="receive.hrDepartment.id" id="select2_sample_deps"  class="m-wrap span6">
														<option value="<s:property value="#receive.hrDepartment.id"/>">原值:<s:property value="#receive.hrDepartment.DName"/></option>
													</select>
													<select name="receive.hrEmployeeByCEmpid.id" id="select2_sample_emps"  class="m-wrap span6">
														<option value="<s:property value="#receive.hrEmployeeByCEmpid.id"/>">原值:<s:property value="#receive.hrEmployeeByCEmpid.name"/></option>
													</select>
												</div>
											</div>
										</div>
									...
									<div class="row-fluid">
										<div class="span12 ">
											<div class="control-group">
												...
												<div class="controls">
													<textarea name="receive.remarks" class="m-wrap span8" ><s:property value="#receive.remarks" /></textarea>
												</div>
											</div>
										</div>
									</div>
