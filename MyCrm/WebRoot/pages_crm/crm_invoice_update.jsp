...
<head>
	<meta charset="utf-8" />
	<title>crm_invoice_update.jsp</title>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form action="crm_invoice!update" method="post" class="form-horizontal">
									<h3 class="form-section">订单信息</h3>
									<input name="invoice.id" value='<s:property value="#invoice.id"/>' type="hidden">
									<div class="row-fluid">
										<div class="span6">
									...
									<div class="row-fluid">
										<div class="span6 ">
											<div class="control-group">
												...
												<div class="controls">
													<input name="invoice.invoiceAmount" value='<s:property value="#invoice.invoiceAmount"/>' type="text" class="m-wrap span8" >
												</div>
											</div>
										</div>
										<!--/span-->
										<div class="span6 ">
											<div class="control-group">
												...
												<div class="controls">
													<select name="invoice.paramSysparam.id" id="receive" class="m-wrap span8">
														<option value="<s:property value="#invoice.paramSysparam.id"/>" >原值:<s:property value="#invoice.paramSysparam.paramsName"/></option>
													</select>
												</div>
											</div>
										</div>
									...
									<div class="row-fluid">
											...
											<div class="control-group">
												...
												<div class="controls">
													<div class="input-append date date-picker" data-date-format="yyyy-mm-dd" data-date-viewmode="years">
														<input name="invoice.invoiceDate" value='<s:date name="#invoice.invoiceDate" format="yyyy-MM-dd"/>' class="m-wrap m-ctrl-medium date-picker" size="16" type="text" />
										...
										<div class="span6 ">
											<div class="control-group">
												...
												<div class="controls">
													<input name="invoice.invoiceNum" value="<s:property value="#invoice.invoiceNum"/>" type="text" class="m-wrap span8" >
												</div>
											</div>
										</div>
									</div>
									<div class="row-fluid">
										<div class="span12 ">
											<div class="control-group">
												...
												<div class="controls">
													<textarea name="invoice.invoiceContent" class="m-wrap span8" ><s:property value="#invoice.invoiceContent"/></textarea>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="row-fluid">
										<div class="span6 ">
											<div class="control-group">
												...
												<div class="controls">
													<select name="invoice.hrDepartment.id" id="select2_sample_deps"  class="m-wrap span6">
														<option value="<s:property value="#invoice.hrDepartment.id"/>">原值:<s:property value="#invoice.hrDepartment.DName"/></option>
													</select>
													<select name="invoice.hrEmployeeByCEmpid.id" id="select2_sample_emps"  class="m-wrap span6">
														<option value="<s:property value="#invoice.hrEmployeeByCEmpid.id"/>">原值:<s:property value="#invoice.hrEmployeeByCEmpid.name"/></option>
													</select>
												</div>
											</div>
										</div>
